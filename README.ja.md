...
---
id: CopilotCLI-ROOT
title: 初心者のための GitHub Copilot CLI
description: AIを活用したターミナルからのコマンドライン支援によって、開発ワークフローを大幅に強化する方法を学びます。
...
![GitHub Copilot CLI 学習パス](assets/learning-path.png)
...
> **注意**: コース内で使用されているコードは、レビュー、説明、デバッグ中に特定の出力を生成するように設計されているため、既存のコードを変更するプルリクエストは受け付けることができません。

**コントリビューション方法:**

1. このリポジトリをフォークし、ローカルマシンにクローンします
2. フィーチャーブランチを作成します (`git checkout -b my-improvement`)
3. 変更を加えます
4. プルリクエストを送信します
